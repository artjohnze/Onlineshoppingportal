						...
						<div class="row  wow fadeInUp">
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									...
									<!-- Removed review count and stars -->
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="favorite-button m-t-10">
													...
													<?php } else { ?>
														<button class="btn btn-secondary" disabled data-toggle="tooltip" data-placement="right" title="Out of Stock - Cannot add to wishlist">
															<i class="fa fa-heart"></i>
														</button>
													<?php } ?>
												</div>
